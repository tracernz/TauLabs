...
/**
 * Configuration for the MPU6500 chip
 */
#if defined(PIOS_INCLUDE_MPU9250_BRAIN)
#include "pios_mpu9250_brain.h"

static const struct pios_exti_cfg pios_exti_mpu9250_cfg_v5 __exti_config = {
	// MPU_INT output on rev5/rev6 hardware (PC13)
...
static const struct pios_mpu9250_cfg pios_mpu9250_cfg = {
	.exti_cfg = &pios_exti_mpu9250_cfg_v5,
...
#error "Not yet implemented"
	...
	/*if(board_v5) { 
		...
		pios_mpu9250_cfg.exti_cfg = &pios_exti_mpu9250_cfg_v5;
	}*/

	uint8_t hw_mpu9250_dlpf;
	HwNazeMPU6000DLPFGet(&hw_mpu9250_dlpf);

	// ignore 256 Hz option as it causes 8 kHz sampling
	// match up as best as possible
	enum pios_mpu9250_gyro_filter mpu9250_gyro_lpf = \
		(hw_mpu9250_dlpf == HWNAZE_MPU6000DLPF_188) ? PIOS_MPU9250_GYRO_LOWPASS_184_HZ : \
		(hw_mpu9250_dlpf == HWNAZE_MPU6000DLPF_98) ? PIOS_MPU9250_GYRO_LOWPASS_92_HZ : \
		(hw_mpu9250_dlpf == HWNAZE_MPU6000DLPF_42) ? PIOS_MPU9250_GYRO_LOWPASS_41_HZ : \
		(hw_mpu9250_dlpf == HWNAZE_MPU6000DLPF_20) ? PIOS_MPU9250_GYRO_LOWPASS_20_HZ : \
		(hw_mpu9250_dlpf == HWNAZE_MPU6000DLPF_10) ? PIOS_MPU9250_GYRO_LOWPASS_10_HZ : \
		(hw_mpu9250_dlpf == HWNAZE_MPU6000DLPF_5) ? PIOS_MPU9250_GYRO_LOWPASS_5_HZ : \
		PIOS_MPU9250_GYRO_LOWPASS_184_HZ;

	enum pios_mpu9250_accel_filter mpu9250_accel_lpf = \
		(hw_mpu9250_dlpf == HWNAZE_MPU6000DLPF_188) ? PIOS_MPU9250_ACCEL_LOWPASS_184_HZ : \
		(hw_mpu9250_dlpf == HWNAZE_MPU6000DLPF_98) ? PIOS_MPU9250_ACCEL_LOWPASS_92_HZ : \
		(hw_mpu9250_dlpf == HWNAZE_MPU6000DLPF_42) ? PIOS_MPU9250_ACCEL_LOWPASS_41_HZ : \
		(hw_mpu9250_dlpf == HWNAZE_MPU6000DLPF_20) ? PIOS_MPU9250_ACCEL_LOWPASS_20_HZ : \
		(hw_mpu9250_dlpf == HWNAZE_MPU6000DLPF_10) ? PIOS_MPU9250_ACCEL_LOWPASS_10_HZ : \
		(hw_mpu9250_dlpf == HWNAZE_MPU6000DLPF_5) ? PIOS_MPU9250_ACCEL_LOWPASS_5_HZ : \
		PIOS_MPU9250_ACCEL_LOWPASS_184_HZ;

	int retval;
	retval = PIOS_MPU9250_Init(pios_i2c_internal_id, PIOS_MPU9250_I2C_ADD_A0_LOW, false,
	...
	// rates above 500 Hz lock the board
	uint8_t mpu_rate;
	HwNazeMPU6000RateGet(&mpu_rate);
	switch(mpu_rate) {
		case HWNAZE_MPU6000RATE_200:
			PIOS_MPU9250_SetSampleRate(200);
			break;
		case HWNAZE_MPU6000RATE_333:
			PIOS_MPU9250_SetSampleRate(333);
			break;
		case HWNAZE_MPU6000RATE_500:
