...
// no input parameters
STM32BL_protocol.prototype.connect = function (port, baud, hex, options, callback) {
    var self = this;
    self.hex = hex;
    self.baud = baud;
...
STM32BL_protocol.prototype.initialize = function () {
    var self = this;
...
STM32BL_protocol.prototype.read = function (readInfo) {
...
STM32BL_protocol.prototype.retrieve = function (n_bytes, callback) {
...
STM32BL_protocol.prototype.send = function (Array, bytes_to_read, callback) {
    // flip flag
...
// result = true/false
STM32BL_protocol.prototype.verify_response = function (val, data) {
    var self = this;
...
// input = 16 bit value
// result = true/false
STM32BL_protocol.prototype.verify_chip_signature = function (signature) {
    switch (signature) {
...
// result = true/false
STM32BL_protocol.prototype.verify_flash = function (first_array, second_array) {
...
STM32BL_protocol.prototype.upload_procedure = function (step) {
    var self = this;
...
// initialize object
var STM32BL = new STM32BL_protocol();
