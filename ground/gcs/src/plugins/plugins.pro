...
#STLoader gadget
plugin_stloader.subdir = stloader
plugin_stloader.depends = plugin_coreplugin
plugin_stloader.depends += plugin_uavobjects
plugin_stloader.depends += plugin_rawhid
SUBDIRS += plugin_stloader
